const wasmURL = "https://esm.sh/markdown-wasm-es@1.2.0/markdown.wasm";
    ...
    function () {
          ...
          function (e) {
            if (
              T--,
                ...
                0 == T && (null !== v && (clearInterval(v), v = null), L)
            ) {
              var t = L;
              L = null, t();
            }
      ...
      function o(n, url) {
        return function () {
          ...
          j("failed to asynchronously prepare wasm: " + e), D(e);
        });
      }
      if (
        T++,
      ...
      load = (url) =>
        y || "function" != typeof WebAssembly.instantiateStreaming || z(W) ||
          V(W) || "function" != typeof fetch
          ? o(r, url || wasmURL)
          : fetch(url || wasmURL).then(function (n) {
...
export { ie as parse, init, re as ParseFlags };

if (import.meta.main) {
  init("https://esm.sh/markdown-wasm@1.2.0/dist/markdown.wasm").then(() => {
